...
Pod::Spec.new do |s|
  ...
  s.author             = { "Edward Lim" => "sgedwardlim@gmail.com" }
  # Or just: s.author    = "Edward Lim"
  # s.authors            = { "Edward Lim" => "sgedwardlim@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Edward Lim"
  ...
  # s.source       = { :git => "http://EXAMPLE/SlideOutNavigation.git", :tag => "#{s.version}" }
  s.source       = { :path => '.' }
